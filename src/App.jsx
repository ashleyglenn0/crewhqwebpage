...
import logoUpdate from "./assets/mmlogo2.PNG";
import infoVideo from "./assets/Bridging_the_Gap__From_Passion_to_Process.mp4";
...
const Button = ({ variant = "primary", children, style = {}, ...props }) => {
  ...
  const color = isPrimary
    ...
    : isGold
      ...
      : theme.primary;
  const border =
    isPrimary || isGold ? "none" : `1.5px solid ${theme.borderStrong}`;
  ...
  return (
    <button
      ...
      style={{
        ...
        boxShadow: isPrimary
          ? hovered
            ? "0 16px 36px rgba(28,74,54,0.25)"
            : "0 8px 24px rgba(28,74,54,0.15)"
          : "none",
        transform: pressed
          ? "scale(0.98)"
          : hovered && !pressed
...
const Divider = () => (
  <div
    style={{ width: 1, height: 48, background: theme.border, flexShrink: 0 }}
  />
);
        ...
        {status === "success" ? (
          ...
          <>
            ...
            >
              ...
              — a practical tool for evaluating whether your event
              infrastructure is ready to run under pressure. No fluff.
            </p>
...
export default function App() {
  ...
  const { inputStyle: salesInputStyle, setFocused: setSalesFocused } =
    useInputStyle();
  ...
  const submitSales = async (e) => {
    ...
    try {
      ...
      await emailjs.send(
        ...
        {
          first_name: sales.contactName,
          to_email: sales.email,
          org_name: sales.orgName,
          role: sales.role,
          event_type: sales.eventType,
    ...
    >
      ...
      >
        ...
        >
          <div className="fade-up">
            ...
            >
              They fail from unclear roles, unsupported teams, and operations
              built on improvisation. Motion & Method builds the infrastructure
              that keeps execution steady under pressure.
            </p>
            ...
            >
              <a
                href="https://calendly.com/ashley-motionmethodgroup/30min"
                target="_blank"
                rel="noreferrer"
          ...
          <div className="fade-up-2">
            <Card
              style={{ background: theme.primary, borderColor: "transparent" }}
            >
              <div
                style={{
                  fontSize: 11,
              ...
              >
                Well-supported people create successful operations. We design
                systems that promote clarity, accountability, and respect — so
      ...
      >
        ...
        >
          {[
            ...
            null,
            { number: "4", label: "years at RenderATL" },
            null,
      ...
      <Section id="who" alt>
        <div style={{ maxWidth: 760, margin: "0 auto", textAlign: "center" }}>
          ...
          >
            Motion & Method was founded by two people who started as volunteers
            and spent years executing events before they had a company name. We
            didn't build a methodology in theory, we built it under pressure, at
            scale, in front of thousands of people.
          </p>
          <p
            style={{
              fontSize: 17,
          ...
          >
            We exist because most events are staffed but not <em>structured</em>
            . People show up without clarity, teams run without support, and
            execution depends on whoever's willing to improvise. We fix that at
            the system level, not the surface level.
          </p>
        </div>
      </Section>
      ...
      <Section id="audience">
        ...
        >
          {[
            {
              icon: "🎪",
              label: "Conference & Festival Producers",
              desc: "Multi-day, high-attendance events where volunteer coordination, zone management, and escalation paths are mission-critical.",
            },
            {
              icon: "💻",
              label: "Tech Event Organizers",
              desc: "RenderATL, Atlanta Tech Week — communities that run complex programming across large footprints and diverse audiences.",
            },
            {
              icon: "🏛️",
              label: "Nonprofits & Civic Organizations",
              desc: "Institutions running large public activations where staff capacity is limited and the stakes for attendee experience are high.",
            },
            {
              icon: "🏢",
              label: "Corporate Event Teams",
              desc: "Internal teams running activations, summits, or brand events who need operational structure without building it from scratch.",
            },
            {
              icon: "🎓",
              label: "Universities & Institutions",
              desc: "Campus and institutional events where leadership development, volunteer management, and operational clarity compound over time.",
            },
            {
              icon: "🤝",
              label: "Strategic Partners",
              desc: "Organizations ready to co-execute at scale — bringing Motion & Method into the operating layer of their events under a shared model.",
            },
          ].map(({ icon, label, desc }) => (
            <Card
              key={label}
      ...
      <Section id="fit" alt>
        ...
        >
          ...
          <a href="#engagement" style={{ textDecoration: "none" }}>
            <Button variant="secondary">See the Engagement Model</Button>
          </a>
        </div>
      </Section>
          ...
          {[
            {
              ...
              desc: "Executive alignment and structured intake to define objectives, surface constraints, assess risk exposure, and establish strategic clarity before any design begins.",
            },
            {
              n: "2",
              title: "System Architecture",
              desc: "Development of the operating structure — role design, workflow modeling, escalation paths, and coordination frameworks that convert strategy into executable infrastructure.",
            },
            {
              n: "3",
              title: "Leadership Enablement",
              desc: "Leadership calibration, expectation architecture, and culture reinforcement that ensures decision authority, coordination rhythms, and accountability align with the operating model.",
            },
            {
              n: "4",
              title: "Execution Reinforcement & Iteration",
              desc: "Live-environment reinforcement and post-engagement refinement to validate performance under pressure and strengthen long-term operational stability.",
            },
          ].map(({ n, title, desc }) => (
            <div
              key={n}
        ...
        >
          {[
            ...
            <Card key={title} style={{ textAlign: "center" }}>
              <div
                style={{ fontSize: 14, color: theme.accent, marginBottom: 12 }}
              >
                {icon}
              </div>
              <h3
      ...
      <Section id="problem">
        ...
        >
          <div>
            ...
            >
              When something goes wrong on event day, it's rarely a staffing
              shortage. It's a clarity shortage. No one knows who owns the
              decision. No one knows who to escalate to. Teams are present but
              not prepared.
            </p>
            <p
              style={{
            ...
            >
              Motion & Method builds the operating layer that solves this —
              before the day-of, not during it.
            </p>
            <a href="#contact" style={{ textDecoration: "none" }}>
      ...
      <Section id="talent">
        ...
        >
          <div>
            ...
            >
              We build our volunteer and contractor pipeline from people who
              want to be part of something that actually runs well.
              Opportunities range from unpaid volunteer floor support to paid
            ...
            >
              Placement is based on event needs — submitting doesn't guarantee a
              specific role or paid position. We'll always be upfront before you
              commit to anything.
            </p>
            <a
              href={RECRUITING_APP_URL}
              target="_blank"
              rel="noreferrer"
              style={{ textDecoration: "none" }}
            >
          ...
          >
            ...
            {[
              {
                stage: "Volunteer",
                desc: "Zone-level floor support. Own your assignment, hold the standard.",
              },
              {
                stage: "Team Lead",
                desc: "Lead a zone. Brief your volunteers. Report up the chain.",
              },
              {
                stage: "Contractor / IC",
                desc: "Paid engagement. Signed IC Agreement. Rate established.",
              },
            ].map(({ stage, desc }, i) => (
              <div
                key={stage}
              ...
              >
                <div
                  style={{
                    ...
                    borderRadius: "50%",
                    flexShrink: 0,
                    background: "rgba(235,199,100,0.15)",
        ...
        >
          <div>
            ...
            <div style={{ display: "grid", gap: 12, marginBottom: 28 }}>
              ...
              <a
                href="mailto:sales@motionmethodgroup.com"
                style={{ textDecoration: "none" }}
              >
                <Card style={{ padding: "16px 20px" }} hover={false}>
                  <div
              ...
              <a
                href="mailto:recruiting@motionmethodgroup.com"
                style={{ textDecoration: "none" }}
              >
                <Card style={{ padding: "16px 20px" }} hover={false}>
                  <div
            ...
            >
              Reserved for organizations seeking operational and infrastructure
              support — not for volunteer or contractor inquiries.
            </p>
          </div>
            ...
            <form onSubmit={submitSales} style={{ display: "grid", gap: 12 }}>
              {[
                ...
                <input
                  ...
                  value={sales[key]}
                  onChange={(e) =>
                    setSales({ ...sales, [key]: e.target.value })
                  }
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: 13, color: theme.textMuted }}>
            Atlanta, GA · motionmethodgroup.com
          </div>
